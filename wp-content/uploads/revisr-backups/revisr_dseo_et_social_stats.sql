...
DROP TABLE IF EXISTS `dseo_et_social_stats`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `dseo_et_social_stats` (
...
LOCK TABLES `dseo_et_social_stats` WRITE;
/*!40000 ALTER TABLE `dseo_et_social_stats` DISABLE KEYS */;
/*!40000 ALTER TABLE `dseo_et_social_stats` ENABLE KEYS */;
UNLOCK TABLES;
